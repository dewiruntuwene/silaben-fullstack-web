...
<body>
	...
	<div class="container-card row">
		<?php foreach ($data['laporan_relawan'] as $laporan): ?>
			<div class="col-md-4 col-lg-3 mb-4">
				<div class="card">
					...
					<div class="card-footer">
						<span class="badge 
							<?php 
							if ($laporan['status_pendaftaran'] === 'APPROVED') {
								echo 'bg-success';
							} elseif ($laporan['status_pendaftaran'] === 'REJECTED') {
								echo 'bg-danger';
							} else {
								echo 'bg-warning';
							} ?>">
							<?php echo ucfirst($laporan['status_pendaftaran']); ?>
						</span>
						<!-- <div class="dropdown">
