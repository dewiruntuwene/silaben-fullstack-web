    ...
    <div class="container">
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active form-section" id="edit-profile">
                <form>
                <input type="hidden" id="relawan_id" value="<?php echo $data['relawan_id']; ?>"> <!-- Hidden input untuk user_id -->
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="nik" class="form-control" id="nik" value="<?php echo $data['nik']; ?>" disabled>
                    </div>
                    <div class="mb-3">
                        <label for="bidang_keahlian" class="form-label">Bidang Keahlian</label>
                        <input type="bidang_keahlian" class="form-control" id="bidang_keahlian" value="<?php echo $data['bidang_keahlian']; ?>" disabled>
                    </div>
                    <div class="mb-3">
                        <label for="tanggal_lahir" class="form-label">Tanggal Lahir</label>
                        <input type="tanggal_lahir" class="form-control" id="tanggal_lahir" value="<?php echo $data['tanggal_lahir']; ?>" disabled>
                    </div>
            ...
            <div class="tab-pane fade form-section" id="change-password">
                ...
                <input type="hidden" id="relawan_id" value="<?php echo $data['relawan_id']; ?>">
                    <div class="mb-3">
...
<script>
    ...
    const relawanId = document.getElementById('relawan_id').value;
    const name = document.getElementById('name').value;
    const gender = document.getElementById('gender').value;
    const whatsapp = document.getElementById('whatsapp').value;
    const email = document.getElementById('email').value;
    const nik = document.getElementById('nik').value;
    const bidang_keahlian = document.getElementById('bidang_keahlian').value;
    ...
    fetch('https://silaben.site/app/public/login/updateRelawan', {
        method: 'POST',
        headers: {
      ...
      .then(result => {
        if (result.succes == 'true') {
            alert(responseData.message || 'Data berhasil diperbarui');
            ...
            saveButton.removeEventListener("click", saveUpdatedData);
    ...
    fetch('https://silaben.site/app/public/login/changePasswordRelawan', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
