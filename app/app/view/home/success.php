			...
			<div class="row justify-content-center">
				<div class="col-lg-7">
					<div class="report-form">
						<div class="form-title text-center" style="background-color: green;">
							<h5>Laporan anda berhasil diproses dan disimpan !!!</h5>
						</div>
						<form id="reportForm" method="POST" action="<?php echo APP_PATH; ?>/home/submitlaporan"  enctype="multipart/form-data">
							<div class="mb-3">
								<label for="category" class="form-label"><strong>Hi <?php echo $data['user_name'];?>, terimakasih telah melakukan pelaporan bencana. Laporan bencana anda telah di proses oleh AI dan telah diterus ke group/instansi terkait. Anda dapat membuat laporan baru, menampilkan map dengan status bencana dan menampilkan daftar laporan bencan yang telah anda submit. Thank you !!!</strong></label>
							</div>
