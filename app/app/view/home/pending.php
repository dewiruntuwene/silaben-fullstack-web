			...
			<div class="row justify-content-center">
				<div class="col-lg-7">
					<div class="report-form">
						<div class="form-title text-center" style="background-color: #f5d445; ">
							<h5>Maaf, laporan anda ditunda !!!</h5>
						</div>
						<form id="reportForm" method="POST" action="<?php echo APP_PATH; ?>/home/submitlaporan"  enctype="multipart/form-data">
							<div class="mb-3">
								<label for="category" class="form-label"><strong>Hi <?php echo $data['user_name'];?> maaf, laporan bencana anda telah di verifikasi oleh AI dan setelah dilakukan pengecekan secara otomatis didapati ketidaksesuai laporan bencana yang anda berikan. 
							 Kami akan melakukan pengecekan dan menilai kesesuaian laporan anda secara manual. Perlu dingat bahwa data pelapor disimpan. Thank you !!!</strong></label> 
							</div>
